...
import {addPost,removePost,editPost,removeAll} from "./Redux/Slices/Posts"
import './App.css';

const App=()=>{

    //If There Is More Than One Reducer Or Here It Named Slice Is Must Ditect Which Slice We want
    //const posts=useSelector(state=>state.posts);
    //Or By Disterbuting No Defference
    ...
    return ( 
        <div className = "app" >
            <h1 className="app-head">Redux App Toolkit </h1>
